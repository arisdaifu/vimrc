...
nnoremap <silent>n :let v:errmsg=''<cr>:silent! norm! n<cr>:set hlsearch<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
nnoremap <silent>N :let v:errmsg=''<cr>:silent! norm! N<cr>:set hlsearch<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
nnoremap <silent>* :let v:errmsg=''<cr>:silent! norm! *<cr>:set hlsearch<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
nnoremap <silent># :let v:errmsg=''<cr>:silent! norm! #<cr>:set hlsearch<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>
...
nnoremap / :set hlsearch<cr>:call <SID>DelaySearchIndex(0,'')<cr>/
nnoremap ? :set hlsearch<cr>:call <SID>DelaySearchIndex(0,'')<cr>?
